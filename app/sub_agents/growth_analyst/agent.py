...
def get_growth_analyst_instruction(context: ReadonlyContext) -> str:
...
당신은 정량분석팀의 성장성(Growth) 분석 담당 실무자입니다.
위 팀 전체 업무 지침 내에서 성장성 분석을 집중적으로 수행하세요.
...
def create_growth_analyst_agent():
    return LlmAgent(
        ...
        model = lite_llm_model("growth_analyst_agent"),
        description = """
        ...
        """,
        instruction = get_growth_analyst_instruction,
...
growth_analyst_agent = create_growth_analyst_agent()
